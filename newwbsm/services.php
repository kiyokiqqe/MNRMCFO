...
$servername = "localhost"; // Змініть на ваше значення
$username = "root"; // Змініть на ваше значення
$password = ""; // Змініть на ваше значення
...
$sql = "SELECT name, details, description FROM Services";
...
<head>
    ...
    <meta charset="UTF-8">
    <title>Послуги</title>
    <link rel='stylesheet' type="text/css" href='css/styleforservices.css'>
                    ...
                    <tbody id="services-table-body">
                        ...
                        if ($result->num_rows > 0) {
                            while($row = $result->fetch_assoc()) {
                                ...
                                echo "<td class='details'>" . htmlspecialchars($row['description']) . "</td>";
                                echo "</tr>";
                            }
                        } else {
